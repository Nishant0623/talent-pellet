<%-- 
    Document   : newjsp
    Created on : 25-Oct-2023, 7:44:30 pm
    Author     : HUDA
--%>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="true" style="color: aliceblue;">
                              Resume
                             </a>
                              <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#" >Create Resume</a></li>
                              </ul>
                             
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" style="color: aliceblue;">Resume Review</a>
                            </li>
                          </ul>
